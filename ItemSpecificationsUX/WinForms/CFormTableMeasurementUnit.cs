...
namespace ItemSpecifications.UX.WinForms
{
    ...
    public partial class CFormTableMeasurementUnit : CFormTemplateTable
    {
        protected CDMMeasurementUnitList module;

        // --------------------------------------------------------------------------------------
        public CFormTableMeasurementUnit() : base()
        {
            InitializeComponent();
            this.module = new CDMMeasurementUnitList();
        }
        // --------------------------------------------------------------------------------------
        protected override void DisplayModelEntitiesOnGrid()
        {
            editableGridRecords.Populate<CMeasurementUnit>(this.module.Model);
        }
        // --------------------------------------------------------------------------------------
